...
public func <=<T>(inout left: T, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().baseType(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary);
    }
}
...
public func <=<T>(inout left: T?, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().optionalBaseType(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=<T, N>(inout left: T, right: (Mapper, MapperTransform<T, N>)) {
    if right.0.mappingType == MappingType.fromJSON {
        ...
        ToJSON().optionalBaseType(value, key: right.0.currentKey!, dictionary: &right.0.currentJSONDictionary)
    }
}
...
public func <=<T: MapperProtocol>(inout left: T, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().object(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=<T: MapperProtocol>(inout left: T?, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().optionalObject(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=<T: MapperProtocol>(inout left: Dictionary<String, T>, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().objectDictionary(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=<T: MapperProtocol>(inout left: Dictionary<String, T>?, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().optionalObjectDictionary(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=(inout left: Dictionary<String, AnyObject>, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().baseDictionary(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=(inout left: Dictionary<String, AnyObject>?, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().optionalBaseDictionary(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=<T: MapperProtocol>(inout left: Array<T>, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().objectArray(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=<T: MapperProtocol>(inout left: Array<T>?, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().optionalObjectArray(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=(inout left: Array<AnyObject>, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().baseArray(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
...
public func <=(inout left: Array<AnyObject>?, right: Mapper) {
    if right.mappingType == MappingType.fromJSON {
        ...
        ToJSON().optionalBaseArray(left, key: right.currentKey!, dictionary: &right.currentJSONDictionary)
    }
}
